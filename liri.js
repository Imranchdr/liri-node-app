...
if (!error) {
    ...
    if(tweets.length > 0){
        ...
        for (var i = 0; i < tweets.length; i++) {
            ...
            console.log('Search for a diffrent handle')
            append('Search for a diffrent handle\n');
                    }
        ...
        case 'spotify-this-song':
            ...
            spotify.search({ type: 'track', query: data }, function(err, results) {
                ...
                if (results.tracks.items[0].artists[0].name) {
                    ...
                    console.log('No results for this song found');
                    append('No results for this song found.\n');
                } 
            });
